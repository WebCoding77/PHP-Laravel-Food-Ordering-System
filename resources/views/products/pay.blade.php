...
<div id="page-content" class="page-content">
    ...
    <div class="container">  
                    ...
                    <script src="https://www.paypal.com/sdk/js?client-id=AUZ7STZEAiU2QgUXFUO6moiSqrSSgumbgMh1uLTN-37i0XdVnD6IG5QgHz_DzVFIO0uC9t70nc_AHIg8&currency=USD"></script>
                    <!-- Set up a container element for the button -->
                    <div style="margin-left: 150px; margin-top: 30px" id="paypal-button-container"></div>
                    <script>
                        paypal.Buttons({
